...
namespace MyToDoWeb.Controllers
{
    ...
    public class ToDoController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ApiResponse> Summary() => await _toDoService.Summary();
        [HttpGet]
        public async Task<ApiResponse> GetAll([FromQuery] ToDoParameter parameter) => await _toDoService.GetAllAsync(parameter);
        [HttpPost]
